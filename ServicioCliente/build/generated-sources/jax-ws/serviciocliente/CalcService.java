 ...
 * 
 */
@WebServiceClient(name = "CalcService", targetNamespace = "http://jaxws/", wsdlLocation = "http://localhost:8080/ServicioWeb/CalcService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCSERVICE_QNAME = new QName("http://jaxws/", "CalcService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServicioWeb/CalcService?wsdl");
    ...
    public Calc getCalcPort() {
        return super.getPort(new QName("http://jaxws/", "CalcPort"), Calc.class);
    }
    ...
    public Calc getCalcPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws/", "CalcPort"), Calc.class, features);
    }
